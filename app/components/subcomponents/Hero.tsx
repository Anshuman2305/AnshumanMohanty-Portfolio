...
function hero() {
  return (
    <div className="hero-container flex flex-col-reverse md:flex-row flex-nowrap gap-8 lg:justify-between lg:items-center w-full lg:max-w-8xl px-4 lg:px-8 py-8 mb-8 md:mb-4">
        ...
        <Image src={"/photos/hero.png"} width={400} height={400} alt="anshuman mohanty" className="hero self-start rounded-xl hidden xl:block md:w-72 md:h-72" />
    </div>
  )
}
