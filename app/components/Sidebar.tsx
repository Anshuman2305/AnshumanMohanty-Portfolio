...
function sidebar() {
  return (
    <div className="sidebar flex flex-col md:flex-row-reverse lg:flex-col w-full max-w-md md:max-w-full lg:max-w-md md:border-[2px] border-dullgreen sm:pt-8 sm:px-2 lg:p-2 rounded-2xl">
      <Experience />
      <Education />
